...
export default function HeroVideoBackground() {
  ...
  return (
    <>
      {!videoFailed && (
        <BackgroundVideo autoPlay loop muted playsInline preload="metadata" poster={FALLBACK_IMAGE_URL} onError={() => setVideoFailed(true)}>
          <source src={VIDEO_URL} type="video/mp4" />
        </BackgroundVideo>
      )}
      {videoFailed && <VideoFallback src={FALLBACK_IMAGE_URL} alt="" aria-hidden="true" />}
